...
1. Nella knowledge base, nella scheda**Coppia di domanda e risposta** selezionare **&#65291;** e creare una nuova coppia di domanda e risposta con le impostazioni seguenti:
    - **Origine**:`https://learn.microsoft.com/en-us/training/support/faq?pivots=general`
    - **Domanda**:`What are the different types of modules on Microsoft Learn?`
    - **Risposta**:`Microsoft Learn offers various types of training modules, including role-based learning paths, product-specific modules, and hands-on labs. Each module contains units with lessons and knowledge checks to help you learn at your own pace.`
1. Selezionare**Fatto**.
1. Nella pagina creata per la domanda**Quali sono i diversi tipi di moduli su Microsoft Learn?**, espandere**Domande alternative**. Aggiungere quindi la domanda alternativa`How are training modules organized?`.
...
1. Nella risposta immessa per la domanda sui tipi di moduli espandere**Richieste di completamento** e aggiungere la richiesta di completamento seguente:
    - **Text displayed in the prompt to the user**:`Learn more about training`.
    - Selezionare la scheda**Crea collegamento a nuova coppia** e immettere il testo seguente:`You can explore modules and learning paths on the [Microsoft Learn training page](https://learn.microsoft.com/training/).`
    - Selezionare**Mostrare solo nel flusso contestuale**. Questa opzione assicura che la risposta venga restituita solo nel contesto di una domanda di completamento dalla domanda originale sui tipi di moduli.
...
1. Immetti il messaggio`What are the different types of modules on Microsoft Learn?`. Verrà restituita la risposta creata insieme a un collegamento per la richiesta di completamento.
1. Selezionare il collegamento di completamento**Altre informazioni sul training**. Verrà restituita una risposta di completamento con un collegamento alla pagina di training.
